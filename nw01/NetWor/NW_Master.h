...
#define tshift 8
	...
	void Store::LandScape()
	{
		...
		for (int y=0;y<11;y++)
		{
			for (x=0;x<11;x++)
			{
				ysub=(int)Blox[mapx+x][mapy+y]/2;
				ysub2=(int)Blox[mapx+x+1][mapy+y]/2;
				ysub3=(int)Blox[mapx+x][mapy+y+1]/2;
				ysub4=(int)Blox[mapx+x+1][mapy+y+1]/2;

				tri0.pax=x<<13;
				tri0.pay=(y<<13)-(ysub<<8);
				tri0.paz=ysub<<hshift;
				tri0.pbx=(x+1)<<13;
				tri0.pby=(y<<13)-(ysub2<<8);
				tri0.pbz=ysub2<<hshift;
				tri0.pcx=x<<13;
				tri0.pcy=((y+1)<<13+256)-(ysub3<<8);
				tri0.pcz=ysub3<<hshift;
				...
				tri0.paz=ysub2<<hshift;
				tri0.pbx=(x+1)<<13;
				tri0.pby=((y+1)<<13+256)-(ysub4<<8);
				tri0.pbz=ysub4<<hshift;
				tri0.pcx=x<<13;
				tri0.pcy=((y+1)<<13+256)-(ysub3<<8);
				tri0.pcz=ysub3<<hshift;
